...
import ToolbarTrader from "../components/ToolbarTrader";
        ...
        <div className="start h-auto">
            ...
            <div className="d-flex">
                ...
                <div className="trader">
                        ...
                        <button className="trader-button" onClick={() => setWeapons(true)}>Weapons</button>
                        <button className="trader-button" onClick={()=> setWeapons(false)}>Potions</button>

                    {weapons ? <Weapons weapons={trader.weapons} /> : <Potions potions={trader.potions}/>}
            </div></div>
<div className="user-weapons">
    <UserInventory/>
</div>
